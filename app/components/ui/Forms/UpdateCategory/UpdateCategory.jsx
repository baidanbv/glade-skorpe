...
const UpdateCategory = ({ onSuccess, categoryId, token }) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await categoriesAPI.updateCategory(formData, token);
  ...
  return (
    <div className="border border-primary rounded-md p-5">
      <h2 className="text-3xl font-kurale mb-6 text-center text-border text-secondary">Update Category</h2>
